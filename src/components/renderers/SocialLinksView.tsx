...
export const SocialLinksView: React.FC = () => (
  <div className="mx-auto flex max-w-3xl flex-col gap-8">
    <div className="text-center">
      ...
      <p className="mt-2 max-w-md mx-auto text-[14px] leading-relaxed text-bb-ink-soft">
        Stay updated with latest achievements, events, opportunities, and
    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      {SOCIAL_LINKS.map((link) => (
        ...
        >
          <Panel
            lift
            className="flex h-full cursor-pointer items-center gap-4 p-5 transition-all"
          >
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded border-[1.5px] border-bb-line-strong bg-bb-surface-2 text-bb-yellow transition-colors group-hover:border-bb-yellow">
              {PLATFORM_ICONS[link.platform] ?? PLATFORM_ICONS.discord}
            </span>
            <div className="min-w-0 flex-1">
              <span className="font-display text-[16px] font-bold uppercase tracking-tight text-bb-ink">
                {link.label}
              </span>
              {link.description && (
            ...
            <span className="font-mono text-[14px] text-bb-ink-faint transition-transform group-hover:translate-x-1 group-hover:text-bb-yellow">
              →
            </span>
          </Panel>
        </a>
